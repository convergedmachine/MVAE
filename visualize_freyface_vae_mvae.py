...
- Loads weights:
    * freyface_zdim2_VAE.pkl
    * freyface_zdim2_MVAE.pkl
- Produces:
...
def main():
    ...
    parser.add_argument("--weights-vae", type=str, default="trained_parameters/freyface_zdim2_VAE.pkl")
    parser.add_argument("--weights-mvae", type=str, default="trained_parameters/freyface_zdim2_MVAE.pkl")
